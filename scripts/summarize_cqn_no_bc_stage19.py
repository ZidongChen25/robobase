#!/usr/bin/env python3
"""Evaluate Stage-19 reward-scaled dense-C51 treatments on seeds 1 and 2."""
...
def summarize(
    ...
    return {
        "protocol": {
            ...
            "q_objective": "categorical_dense_return_c51",
            "q_reward_scale": 2.0,
