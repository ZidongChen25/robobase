#!/usr/bin/env python3
"""Evaluate Stage-17 corrected replay-SARSA dense Q on seeds 1 and 2."""
...
def summarize(
    ...
    return {
        "protocol": {
            ...
            "implementation_path": "no_policy_parent_td_hook",
        ...
        "corrected_replay_sarsa_treatments": treatments,
        "baseline_mean": baseline_mean,
        "treatment_mean": treatment_mean,
        "per_seed_improvements": improvements,
        "mean_improvement": mean_improvement,
        "both_at_least_60": both_at_least_60,
        "corrected_replay_sarsa_gate": "pass" if gate_pass else "fail",
    }
