#!/usr/bin/env python3
"""Evaluate Stage-18 dense expected-Q treatments on seeds 1 and 2."""
...
def summarize(
    ...
    return {
        "protocol": {
            ...
            "dense_return_loss": "half_squared_expected_q",
