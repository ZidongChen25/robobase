#!/usr/bin/env python3
"""Evaluate Stage-20 gap-increasing Bellman treatments on seeds 1 and 2."""
...
def summarize(
    ...
    return {
        "protocol": {
            ...
            "q_objective": "gap_increasing_dense_return_c51",
