#!/usr/bin/env python3
"""Evaluate Stage-13 finest-neighbor return-Q on seeds 1 and 2."""
...
def summarize(
    ...
    return {
        ...
        "finest_neighbor_treatments": treatments,
        "baseline_mean": baseline_mean,
        "treatment_mean": treatment_mean,
        "per_seed_improvements": improvements,
        "mean_improvement": mean_improvement,
        "both_at_least_60": both_at_least_60,
        "finest_neighbor_gate": "pass" if gate_pass else "fail",
    }
